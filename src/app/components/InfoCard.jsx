    ...
    return (
        <>
            ...
            <section className="flex flex-col gap-y-3">
                ...
                <h1 className="text-lg font-semibold text-[#808080] max-w-195 ">
                    {heading}
                </h1>
                <p className="text-base text-[#808080] max-w-130 ">
                    {description}
                </p>
                ...
                <ul className="flex flex-col gap-y-2">
                    <li className="flex items-center gap-x-3">
                        ...
                        <p className="text-sm text-[#808080] ">{bullet}</p>
                    </li>
                    <li className="flex items-center gap-x-3">
                        <span className={`${bulletClr} rounded-full w-2.5 h-2.5 flex-shrink-0`}></span>
                    ...
                    <li className="flex items-center gap-x-3">
                        ...
                        <p className={`text-sm text-[#808080]`}>{bullet4}</p>
                    </li>
                </ul>
                ...
                <p className="text-base text-[#808080] max-w-130 font-semibold">
                    {description2}
                </p>
