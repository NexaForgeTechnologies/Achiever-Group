export default function GapsDivComp({ icon, title, detail, flex="flex-row", iconWidth="w-15 md:w-15", textCenter }) {
  return (
    <div className={`border border-[#BF8933] flex flex-col lg:${flex} items-center justify-between md:justify-evenly gap-y-5 lg:gap-y-0 gap-x-0 lg:gap-x-5 p-3 rounded bg-white py-5 w-full`}>
