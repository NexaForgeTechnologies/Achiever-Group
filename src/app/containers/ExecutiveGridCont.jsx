...
export default function ExecutiveGridCont() {
    return (
        <>
            <section className="py-10 md:pb-15 md:pt-5 relative w-screen ml-[calc(50%-50vw)] px-5 sm:px-10 md:px-18 lg:px-20">
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-7 gap-y-15 ">
                    ...
                    <div className="flex flex-col gap-y-5 justify-center items-center lg:items-start lg:row-start-1">
                        ...
                        <ul className="flex flex-col gap-y-2 max-w-85">
                            <li className="flex items-center gap-x-3">
                                ...
                                <p className="text-sm text-gray-500 lg:text-start">Frustration with fragmented opportunities and rigid systems.</p>
                            </li>
                            <li className="flex items-center gap-x-3">
                                <span className={`bg-[#A55C2F] rounded-full w-2.5 h-2.5 flex-shrink-0`}></span>
                                <p className="text-sm text-gray-500 lg:text-start">Faith in people’s potential to thrive when given the right tools and community.</p>
                            </li>
                        </ul>
                    ...
                    <div className="flex flex-col gap-y-5 justify-center items-center lg:items-start p-0 lg:pl-10">
                        ...
                        <ul className="flex flex-col gap-y-2 justify-center max-w-85">
                            <li className="flex items-center gap-x-3">
                                <span className={`bg-[#A55C2F] rounded-full w-2.5 h-2.5 flex-shrink-0`}></span>
                                <p className="text-sm text-gray-500 lg:text-start">Cross-sector experience and enterprise insight</p>
                            </li>
                            <li className="flex items-center gap-x-3">
                                <span className={`bg-[#A55C2F] rounded-full w-2.5 h-2.5 flex-shrink-0`}></span>
                                <p className="text-sm text-gray-500  lg:text-start">Strategic rigour for scale-up success</p>
                            </li>
                            <li className="flex items-center gap-x-3">
                                <span className={`bg-[#A55C2F] rounded-full w-2.5 h-2.5 flex-shrink-0`}></span>
                                <p className="text-sm text-gray-500 max-w-125 lg:text-start">Trusted counsel to keep Achiever Group’s ventures impactful, sustainable, and future-ready</p>
                            </li>
                        </ul>
