        ...
        bg-gradient-to-b from-orange-50 to-white-50 w-full mb-20">
            ...
            <section className="grid grid-rows-2 grid-cols-4 relative px-5">
                ...
                <div className="absolute w-full h-full flex justify-center items-center">
                    <span className="absolute border-2 border-[#000000] w-[72%] border-dashed top-1/2 "></span>
                </div>


                <div className="row-start-2 flex flex-col items-center justify-start text-center px-1 relative -top-1">
                    <span className="bg-[#A55C2F] rounded-full w-3 h-3 z-10 "></span>
                ...
                <div className="row-start-1 col-start-2 flex flex-col items-center justify-end text-center px-1 relative -bottom-2">
                    <p className="text-[#BF8933] text-[10px] sm:text-sm md:text-sm lg:text-xl my-5">
                ...
                <div className="row-start-1 col-start-4 flex flex-col items-center justify-end text-center px-1 relative -bottom-2">
                    <p className="text-[#BF8933] text-[10px] sm:text-sm md:text-sm lg:text-xl my-5">
