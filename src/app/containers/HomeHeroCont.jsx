        ...
        <section className="flex flex-col items-center justify-center pt-10 pb-5 md:pb-20 md:pt-30 px-5 sm:px-10 md:px-18 lg:px-20 gap-y-5 w-screen ml-[calc(50%-50vw)] min-h-140 bg-[url('/herobg.png')] bg-no-repeat bg-cover bg-center">
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2">
                <div className="flex flex-col justify-start gap-y-5">
                    ...
                    <p className="text-base text-gray-500 max-w-195 text-center md:text-start">Achiever Group is an innovative venture studio, the parent company behind a suite of purpose-driven platforms designed to accelerate careers, build bold leaders, and enable organisations to thrive.</p>
