            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-20 py-10 md:py-20 lg:py-30">
                ...
                <div>
                    <InfoCard
                        ...
                        description2={'PTX - Project and Talent Xchange – our cross-sector cross industry talent exchange platform that drives real-time professional growth and organizational learning.'}
                        bulletClr={'bg-[#5D2F6A]'}
                        hide={'hidden'}
                    />
                </div>
